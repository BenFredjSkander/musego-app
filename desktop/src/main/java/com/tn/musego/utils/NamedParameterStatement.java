 ...
 * <p>
 * NOTE 2: Dejan Lekic added the missing set methods. Original code had only few (the most commonly used
 * ones.
 *
 * @author Adam Crume
 * @author Dejan Lekic
...
public class NamedParameterStatement {
    ...
    static final String parse(String query, Map paramMap) {
        // I was originally using regular expressions, but they didn't work well  for ignoring parameter-like 
