...
public class PassResetVerifyForm extends Form {

    public PassResetVerifyForm(Form previous, String email) {
        super();
        ...
        Button verifButton = new Button("Vérifier mon code");
        verifButton.addActionListener(evt -> AuthService.getInstance().verifyReset(this, email, code.getText()));
        ...
        addAll(CustomComponent.emptyContainer(5), text, code, verifButton);
